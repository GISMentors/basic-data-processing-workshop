...
.. only:: html
   ...
   .. image:: images/rasters-are-pixels.png
      :width: 140px
      :align: left

.. only:: latex

   .. figure:: images/rasters-are-pixels.png
      :scale-latex: 80

.. notedata::

   *Data GISMentors* jsou stažitelné jako `zip archiv
   <http://training.gismentors.eu/geodata/data-processing/gismentors.zip>`_
   (XXX MB).
...
* `Školení GeoPython <http://training.gismentors.cz/geopython-zacatecnik/>`_
* ...
...
.. only:: latex
   ...
   * http://training.gismentors.eu/basic-data-processing-workshop

Zdrojové texty školení jsou dostupné na adrese:

* https://github.com/GISMentors/basic-data-processing-workshop
